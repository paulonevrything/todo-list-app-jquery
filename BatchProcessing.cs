    ...
    public class BatchScoreRequest
{
    ...
    class Program
    {
        ...
        static async Task InvokeBatchExecutionService()
        {
            ...
            const string BaseUrl = "https://ussouthcentral.services.azureml.net/workspaces/9dbdce0846e64a5f9c925116e0cb6388/services/87bfd4ea0615412bac19c34422ced730/jobs";
            ...
            const int TimeOutInMilliseconds = 120 * 1000; // Set a timeout of 2 minutes
             ...
             UploadFileToBlob("inputdata.csv" /*Replace this with the location of your input file*/,
                "inputdatablob.csv" /*Replace this with the name you would like to use for your Azure blob; this needs to have the same extension as the input file */,
            ...
            using (HttpClient client = new HttpClient())
            {
                var request = new BatchScoreRequest()
                {
                    ...
                    Input = new AzureBlobDataReference()
                    {
                        ...
                        RelativeLocation = string.Format("{0}/inputdatablob.csv", StorageContainerName)
                    },
